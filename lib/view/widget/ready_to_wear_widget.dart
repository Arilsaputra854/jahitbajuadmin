...
class readyToWearWidget extends StatefulWidget {
  const readyToWearWidget({super.key});

  @override
  State<readyToWearWidget> createState() => _readyToWearWidgetState();
}

class _readyToWearWidgetState extends State<readyToWearWidget> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Row(
                                children: [
                                  controller.products[index].imageUrl.isNotEmpty
                                      ? CachedNetworkImage(
                                        imageUrl:
                                            controller
                                                .products[index]
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${controller.products[index].stock} stok produk tersisa"
                                              .toString(),
    ...
    if (controller.currentProduct != null) {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder:
              (context) =>
                  ModifyProductPage(product: controller.currentProduct!),
        ),
      );
    }
  }
