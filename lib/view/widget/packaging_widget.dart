...
Widget packagingWidget(BuildContext context,{int weight = 500}) {
  return Consumer<PackagingController>(
    builder: (context, controller, child) {
      ...
      return Stack(
        children: [
          Scaffold(
            appBar: AppBar(centerTitle: true, title: Text("Packaging",style: TextStyle(fontWeight: FontWeight.bold),)),
            ...
            body: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    controller.setCurrentPackaging(controller.packaging[index]);
                    addNewPackaging(context, controller)                    ;
                  },
                  child: Card(
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          IconButton(onPressed: (){
                            controller.removePackaging(controller.packaging[index].id);
    ...
    builder: (context) {
      return AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: controller.currentPackaging != null ? (){
              //update
            ...
            child:controller.currentPackaging != null ? Text("Update") :  Text("Simpan"),
          ),
        ],
      );
    },
